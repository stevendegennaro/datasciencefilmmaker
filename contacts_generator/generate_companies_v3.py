...
names = list(set([word for name in fullnames for word in name.split() if word not in common_suffixes.keys()]))
...
weightfile = "weights/weights_v3.txt"
vocabfile = "weights/vocab_v3.txt"
...
# Train the network
batchsize = 5000   # number of names to use for each round of training
batchsize = len(names)
...
with open('generated_v3.txt',"a") as f:
